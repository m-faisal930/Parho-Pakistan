...
// import { FaSearch, FaEdit, FaDownload, FaTrash, FaTimes } from 'react-icons/fa';
...
//     if (
//       currentHobby.trim() &&
//       !formData.hobbies.includes(currentHobby.trim())
//     ) {
//       setFormData({
//         ...formData,
//         hobbies: [...formData.hobbies, currentHobby.trim()],
//       });
//       setCurrentHobby('');
//     }
//   };
...
//         body: JSON.stringify({
//           ...formData,
//           studentId: '65d9f2c9b1e9c6d50a3b5e12',
//           schoolId: '67cd4953827bb17fc8b7c9de',
//         }),
//       });
...
//                   {student.sponsored === 'Yes' && (
//                     <button
//                       disabled
//                       className="bg-blue-100 text-white px-2 py-1 rounded-md flex items-center gap-1"
//                     >
//                       <FaEdit /> Create Case
//                     </button>
//                   )}

//                   {student.sponsored === 'No' && (
//                     <button
...
//                   {Object.entries(formData.donationBreakdown).map(
//                     ([category, amount]) => (
